        ...
        <div class="left-panel">
            ...
            <div class="left-panel-main">
                <div class="opp" id="opp1">
                    ...
                    <span><a href="Create.jsp">Create</a> Bank Account</span>
                </div>
                <div class="opp" id="opp2">
                    <img src="remove-user.png" alt="#">
                    <span><a href="Delete.jsp">Delete</a> Bank Account</span>
                </div>
                <div class="opp" id="opp3">
                    <img src="update.png" alt="#">
                    <span><a href="Update.jsp">Update</a> Bank Account</span>
                </div>
                <div class="opp" id="opp4">
                    <img src="file.png" alt="#">
                    <span>Account Details <a href="Details.jsp">Details</a></span>
                </div>
                <div class="opp" id="opp5">
                    <img src="receive-money.png" alt="#">
                    <span>Funds <a href="FundReq.jsp">Requests</a></span>
                </div>
                <div class="opp" id="opp6">
                    <img src="icons8-more-details-100.png" alt="#">
                    <span>Transaction <a href="TransactionDetails.jsp">Details</a></span>
                </div>
            </div>
        </div>
        <div class="right-cor">
