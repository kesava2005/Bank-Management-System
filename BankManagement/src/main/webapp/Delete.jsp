...
<body>
    ...
    <div class="create-heading">
        <h2>Fill the below form and submit to Delete a bank user</h2>
    </div>
    <div>
        <form action="/DeleteUser" method="post" class="form1" onsubmit="return validate()">
            <label for="uid">Enter User Id: </label>
            <input type="number" name="uid" id="uid" autocomplete="off">
            <input type="submit" value="Delete" id="butt">
        </form>
		<%
